...
import com.dre.loyalty.core.networking.CashBackService
...
class CashBackListCloudDataSource @Inject constructor(
    private val service: CashBackService
) : CashBackListCloudDataSourceContract {
    override fun getCashBackList(request: CashBackRequest): Call<LoyaltyResponse<List<CashBackResponse>>> {
        return service.getCashBackList(request)
    }
}